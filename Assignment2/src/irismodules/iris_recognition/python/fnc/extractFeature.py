...
from src.irismodules.iris_recognition.python.fnc.segment import segment
from src.irismodules.iris_recognition.python.fnc.normalize import normalize
from src.irismodules.iris_recognition.python.fnc.encode import encode
