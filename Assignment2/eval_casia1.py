...
from src.irismodules.iris_recognition.python.fnc.extractFeature import extractFeature
from src.irismodules.iris_recognition.python.fnc.matching import calHammingDist
...
CASIA1_DIR = "data/CASIAv2_prepped/val"
N_IMAGES = 4
